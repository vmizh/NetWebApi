...
internal static class JsState
{
    ...
    [ThreadStatic] internal static bool IsCsv = false;

    [ThreadStatic] internal static Type DeclaringType;

    [ThreadStatic] internal static HashSet<Type> InSerializerFns = new HashSet<Type>();

    [ThreadStatic] internal static HashSet<Type> InDeserializerFns;
